 ...
 */
export function formatMessage({ text, notes, location, kind = 'error' }: Message, color = true): string {
 ...
 */
export function parsePackageJSON<T extends PackageJSON = PackageJSON>(input: string, file?: string): T {
