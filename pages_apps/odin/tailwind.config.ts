 ...
 */
function getColorsFromName(name: string, variants: number[] = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950]) {
  return Object.fromEntries(variants.map(n => [`${n}`, getColorFromVariableName(`${name}-${n}`)]));
}
