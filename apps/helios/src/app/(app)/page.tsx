                ...
                <div className="col-start-1 row-start-1 mx-6 flex items-end gap-6 xl:mx-0 xl:items-start xl:gap-0">
                  <div className="flex gap-6 xl:w-60 xl:flex-col xl:gap-0">
                    ...
                    >
                      ...
                      <div className="rounded-b-box rounded-tr-box h-60 shrink-0 bg-base-100">
                      ...
                      <div className="card-body" data-svelte-h="svelte-1vywksf">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-primary"></div>
                            <div className="text-[.6rem] text-base-content/60">primary</div>
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-secondary"></div>
                            <div className="text-[.6rem] text-base-content/60">secondary</div>
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-accent"></div>
                            <div className="text-[.6rem] text-base-content/60">accent</div>
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-neutral"></div>
                            <div className="text-[.6rem] text-base-content/60">neutral</div>
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-info"></div>
                            <div className="text-[.6rem] text-base-content/60">info</div>
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-success"></div>
                            <div className="text-[.6rem] text-base-content/60">success</div>
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-warning"></div>
                            <div className="text-[.6rem] text-base-content/60">warning</div>
                          </div>
                          <div className="flex flex-col items-center gap-1">
                            <div className="rounded-btn aspect-square w-10 bg-error"></div>
